...
const SPEED_DIAL_ACTIONS: SpeedDialAction[] = [
    { icon: FileInput,    label: "New Sale",     href: "/sales/new",         color: "#16A34A" },
    { icon: Truck,        label: "New Arrival",  href: "/arrivals",          color: "#1A6B3C" },
    { icon: Users,        label: "Add Contact",  href: "/contacts",          color: "#2563EB" },
    { icon: ShoppingCart, label: "Quick Entry",  href: "/stock/quick-entry", color: "#7C3AED" },
    { icon: Wallet,       label: "Add Payment",  href: "/finance/payments",  color: "#D97706" },
];
