-- Update confirm_sale_transaction RPC to include buyer expense fields
...
-- Recreate with new buyer expense parameters
...
BEGIN
    ...
    -- 2. Insert Sale Record with buyer expenses
    INSERT INTO sales (
    ...
    -- Include all fees and buyer expenses in total payable
