-- ============================================================
-- FIX INSTANT PAYMENTS & CHEQUE CLEARANCE LOGIC
-- Migration: 20260421110000_fix_instant_payments.sql
-- Goals:
-- 1. Automate receipt generation for Cash, UPI, and Instantly Cleared Cheques right from the Sales Form.
-- 2. Leave Uncleared Cheques as 'pending' Udhaar to be cleared later via clear_cheque.
-- ============================================================
...
BEGIN
    ...
    v_payment_status := 'pending'; -- default to pending (Udhaar)
        ...
        BEGIN
            ...
            IF v_cash_bank_acc_id IS NOT NULL THEN
                INSERT INTO mandi.vouchers (
                    ...
                    'Instant Receipt - Sale #' || v_bill_no, v_total_inc_tax,
                ...
                INSERT INTO mandi.ledger_entries (
                    ...
                    p_organization_id, v_payment_voucher_id, p_buyer_id, 0, v_total_inc_tax, p_sale_date,
                ...
                INSERT INTO mandi.ledger_entries (
                    ...
                    p_organization_id, v_payment_voucher_id, v_cash_bank_acc_id, v_total_inc_tax, 0, p_sale_date,
