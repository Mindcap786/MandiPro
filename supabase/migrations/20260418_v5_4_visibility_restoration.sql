-- ============================================================
-- MANDIGROW VISIBILITY RESTORATION (v5.4)
-- PURPOSE: Ensure 'posted' and 'confirmed' rows are visible.
-- ============================================================

BEGIN;

-- 1. UPDATE: get_ledger_statement
-- We broaden the status filter to include all non-cancelled states.
