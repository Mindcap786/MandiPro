-- Keep sales RPCs inside the mandi schema only.
-- This migration removes the public copy of confirm_sale_transaction and
-- recreates the latest implementation under mandi.

DROP FUNCTION IF EXISTS public.confirm_sale_transaction(uuid, uuid, date, text, numeric, jsonb, numeric, numeric, numeric, numeric, numeric, numeric, uuid, date, uuid, text, date, boolean);
...
DROP FUNCTION IF EXISTS mandi.confirm_sale_transaction(uuid, uuid, date, text, numeric, jsonb, numeric, numeric, numeric, numeric, numeric, numeric, uuid);
